[![Run App Matthew Donsig](https://github.com/Mdonsig2/GithubActionsDonsig/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Mdonsig2/GithubActionsDonsig/actions/workflows/run-app.yaml)
